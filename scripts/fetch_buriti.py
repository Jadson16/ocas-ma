"""
Coleta dados PEVS (buriti - fibra) do SIDRA/IBGE para municípios do Maranhão.
...
STATE_CODE = 21
CLASSIFICATION = 193
CATEGORY = 3423          # Buriti (fibra)
START_YEAR = 1995
END_YEAR = 2024

DATA_DIR = Path(__file__).parent.parent / "data" / "buriti"
OUT_FILE = DATA_DIR / "buriti_pevs.csv"
...
def main():
    url = build_url()
    print(f"Requisicao SIDRA (buriti):\n{url}\n")
