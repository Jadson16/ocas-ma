"""
Coleta dados PAM — lavouras temporárias do SIDRA/IBGE para municípios do Maranhão.
Tabela 1612 — variáveis 214 (quantidade, t) e 215 (valor, mil R$), classificação 81.
...
PRODUCTS = {
    ...
    "feijao":   (2702, "Feijao (em grao)"),
    "mandioca": (2708, "Mandioca"),
    "milho":    (2711, "Milho (em grao)"),
    "soja":     (2713, "Soja (em grao)"),
    "cana":     (2696, "Cana-de-acucar"),
    "melancia": (2709, "Melancia"),
    "amendoim": (2691, "Amendoim (em casca)"),
    "algodao":  (2689, "Algodao herbaceo (caroco)"),
}
